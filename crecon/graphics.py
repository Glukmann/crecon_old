...
class Graph(TemplateView):
    ...
    def prognoz(self, data_df):
        ...
        ngod = pd.DataFrame({
            'holiday': 'ngod',
            'ds': pd.to_datetime(['2016-12-30', '2017-12-30']),
            'lower_window': -10,
            'upper_window': 0,
        })
        valday = pd.DataFrame({
            'holiday': 'valday',
            'ds': pd.to_datetime(['2016-02-14', '2017-02-14', '2018-02-14',
                                  '2016-03-08', '2017-03-08', '2018-02-14']),
            'lower_window': -3,
            'upper_window': 1,
        })
        ...
        m = Prophet(holidays=holidays, holidays_prior_scale=10, changepoint_prior_scale=0.05, growth='logistic', mcmc_samples=300)
